...
A TellStick (or TellStick Duo/ZNet) reachable via `telldusd` -- e.g. the [Telldus add-on](https://github.com/michaelarnauts/home-assistant-tellstick-addon) if you're running Home Assistant OS/Supervised, a local USB TellStick or a networked TellStick where you setup your own TCP bridge.
